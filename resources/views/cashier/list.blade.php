                ...
                @can('view applicants')
                    ...
                    <a href="{{ route('cashier.rejected') }}" 
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" 
                            ...
                            class="w-5 h-5 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round" 
                                d="M18.364 5.636a9 9 0 11-12.728 12.728A9 9 0 0118.364 5.636zm-12.728 0l12.728 12.728" />
                        </svg>
                            ...
                            <table id="applicantsTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-700 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-status">Payment Status</th>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <td colspan="7" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center space-y-3">
                                        ...
                                        <div class="text-lg font-medium text-gray-400 dark:text-gray-500">No payment records found</div>
                                        <div class="text-sm text-gray-400 dark:text-gray-500">There are currently no payment records available to display</div>
                                    </div>
                                </td>
                            </tr>
                        `);
                                ...
                                <td class="px-6 py-4 text-center column-receipt">
                                    ${payment.payment_proof_path 
                                        ? `<a href="${receiptUrl}" target="_blank" 
                                            ...
                                            <span class="text-blue-600 text-center group-hover:text-white text-sm">View Receipt</span>
                                        </a>` 
                                        : 'No receipt'}
                                </td>
