<x-app-layout>
    <x-slot name="header">
        <x-page-header title="{{ __('Main Carousel') }}">
            <x-slot name="createButton">
                <x-create-button 
                    :route="route('main-carousels.create')" 
                    permission="create main carousels" />
            </x-slot>
        </x-page-header>
    </x-slot>
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-lg font-medium">No carousels found</p>
                                        <p class="text-sm mt-1">There are currently no carousel items to display.</p>
                                    </div>
                                </td>
                            </tr>
                        `);
                    ...
                    carousels.forEach((carousel, index) => {
                        ...
                        let row = `
                            <tr class="border-b table-row-hover table-row-animate dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-center column-title">${carousel.title}</td>
                                <td class="px-6 py-4 text-center column-content">${carousel.content}</td>
                                <td class="px-6 py-4 text-center column-image">${carousel.image}</td>
                                <td class="px-6 py-4 text-center column-author">${carousel.author}</td>
                                <td class="px-6 py-4 text-center column-status">${carousel.status}</td>
                                <td class="px-6 py-4 text-center column-created">${carousel.created_at}</td>
