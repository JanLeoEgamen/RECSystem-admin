            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-6" role="alert">
                        ...
                        <p>This is a student applicant. Payment requirement is waived for student applications.</p>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input value="{{ old('student_number', $applicant->student_number) }}" name="student_number" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100" readonly>
                                    </div>
                                    <div>
                                        <label for="school" class="block text-sm font-medium">School/University</label>
                                        <input value="{{ old('school', $applicant->school) }}" name="school" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100" readonly>
                                    </div>
                                    <div>
                                        <label for="program" class="block text-sm font-medium">Program/Course</label>
                                        <input value="{{ old('program', $applicant->program) }}" name="program" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100" readonly>
                                    </div>
                                    <div>
                                        <label for="year_level" class="block text-sm font-medium">Year Level</label>
                                        <input value="{{ old('year_level', $applicant->year_level) }}" name="year_level" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        <label for="section_id" class="block text-sm font-medium">Section <span class="text-xs text-gray-500">(Student Sections Only)</span></label>
