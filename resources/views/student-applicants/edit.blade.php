<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('student-applicants.update', $applicant->id) }}" method="post" enctype="multipart/form-data" id="studentApplicationForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input value="{{ old('student_number', $applicant->student_number) }}" name="student_number" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('school', $applicant->school) }}" name="school" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                        @error('school')
                                        <p class="text-red-400 font-medium text-sm">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div>
                                        ...
                                        <input value="{{ old('program', $applicant->program) }}" name="program" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                        @error('program')
                                        <p class="text-red-400 font-medium text-sm">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div>
                                        ...
                                        <input value="{{ old('year_level', $applicant->year_level) }}" name="year_level" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                        @error('year_level')
                                        <p class="text-red-400 font-medium text-sm">{{ $message }}</p>
                                        @enderror
                                    </div>
    ...
    <div id="loadingOverlay" class="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50 hidden">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-center">
            ...
            <p class="text-gray-900 dark:text-gray-100 text-lg">Updating student applicant information...</p>
        </div>
    </div>
...
$(document).ready(function() {
    $('#updateButton').on('click', function(e) {
        ...
        Swal.fire({
            title: 'Update Student Applicant Information?',
            text: "Are you sure you want to update this student applicant's information?",
            icon: 'question',
    ...
    // Address dropdown functionality (same as regular applicants)
