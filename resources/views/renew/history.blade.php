                            ...
                            <table id="historyTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-700 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-processor">Processed By</th>
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-processed_at">Processed At</th>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-lg font-medium mb-2">No renewal history found</p>
                                        <p class="text-sm">There are no processed renewal requests matching your search criteria.</p>
                                    </div>
                                </td>
                            </tr>
                        `);
