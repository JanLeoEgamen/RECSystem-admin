                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="my-3">    
                                        <input value="{{ old('url') }}" name="url" id="url" placeholder="https://example.com/document.pdf" type="url" class="border-gray-300 shadow-sm w-full rounded-lg">
                                        @error('url')
                                        <p class="text-red-400 font-medium"> {{ $message }} </p>
                                        @enderror
                                    </div>
                                        ...
                                        <div id="members-options" class="mt-1 max-h-60 overflow-y-auto border border-gray-300 rounded-lg hidden">
                                            <div class="p-2">
                                                <div class="flex items-center mb-2">
                                                    ...
                                                    <label for="select-all" class="text-sm">Select All Visible Members</label>
                                                </div>
