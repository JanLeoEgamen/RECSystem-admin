                            ...
                            <table id="documentsTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-700 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-file_info">File Info</th>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm mt-1">There are currently no documents to display.</p>
                                    </div>
                                </td>
                            </tr>
                        `);
                    ...
                    documents.forEach((document, index) => {
                        ...
                        let row = `
                            <tr class="border-b table-row-hover table-row-animate dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-center column-title">${document.title}</td>
                                <td class="px-6 py-4 text-center column-file_info">${fileInfo}</td>
                                ...
                                <td class="px-6 py-4 text-center column-author">${document.author}</td>
                                <td class="px-6 py-4 text-center column-created">${document.created_at}</td>
