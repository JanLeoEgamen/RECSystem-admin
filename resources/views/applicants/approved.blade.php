                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="hidden sm:flex justify-between items-center mb-4 gap-4">
                                    ...
                                    <div id="columnFilterDropdown" class="hidden absolute left-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-md shadow-lg z-10 border border-gray-200 dark:border-gray-700">
                                        <div class="p-2">
                                            <div class="space-y-2">
                                                ...
                                                <label class="flex items-center space-x-2 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded cursor-pointer">
                                                    <input type="checkbox" class="column-checkbox" data-column="approved" checked>
                                                    <span class="text-sm text-gray-700 dark:text-gray-300">Approved On</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <input type="text" id="searchInput" placeholder="Search approved applicants..." 
                    ...
                    <div class="sm:hidden space-y-3 mb-4">
                        <!-- Search bar -->
                        <input type="text" id="mobileSearchInput" placeholder="Search approved applicants..." 
                            ...
                            <table id="approvedApplicantsTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-800 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l border-white column-approved">Approved On</th>
                    ...
                    applicants.forEach((applicant, index) => {
                        ...
                        let row = `
                            <tr class="border-b table-row-hover table-row-animate dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-left column-approved">${applicant.updated_at}</td>
