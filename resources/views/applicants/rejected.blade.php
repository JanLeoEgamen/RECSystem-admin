        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table id="rejectedApplicantsTable" class="w-full">
                        <thead class="bg-gray-50">
                            <tr class="border-b">
                                ...
                                <th class="px-6 py-3 text-left">Rejected On</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#rejectedApplicantsTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('applicants.rejected') }}",
                    columns: [
                        { 
                            data: 'DT_RowIndex', 
                            name: 'DT_RowIndex', 
                ...
                if (confirm("Are you sure you want to restore this applicant to pending status?")) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                alert(response.message); // Or use a better notification system
                                $('#rejectedApplicantsTable').DataTable().ajax.reload();
                            } else {
