<x-app-layout>
                ...
                <div class="p-8 md:p-10">
                    ...
                    <div class="mb-8 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <h3 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Edit Community Content</h3>
                        </div>
                        <p class="text-gray-600 dark:text-gray-400 ml-16">Update the community information below</p>
                    </div>

                    <form id="communityEditForm" action="{{ route('communities.update', $community->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 mb-6">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100">Community Details</h4>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="content" name="content" placeholder="Enter community content" rows="5"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4">{{ old('content', $community->content) }}</textarea>
                                @error('content')
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 mb-6">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100">Community Image</h4>
                            </div>
                            ...
                            <div>
                                <label for="image" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    <span class="flex items-center gap-2">
                                        ...
                                        {{ $community->image ? 'Replace Image' : 'Upload Image' }}
                                    </span>
                                </label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative inline-block">
                                        <img src="{{ asset('images/' . $community->image) }}" alt="Current Community Image" class="max-w-full h-auto rounded-lg shadow-lg border-2 border-gray-300 dark:border-gray-600" style="max-height: 400px;">
                                ...
                                @enderror
                                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">{{ $community->image ? 'Leave empty to keep current image' : 'Please upload an image for the community' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="checkbox" name="status" id="status" class="w-5 h-5 rounded text-teal-600 focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:border-gray-600 transition-all duration-200" value="1" 
                                ...
                                <button type="button" id="updateCommunityBtn"
                                    class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 text-lg">
    ...
    <script>
        ...
        document.getElementById('updateCommunityBtn').addEventListener('click', function() {
            Swal.fire({
                title: 'Update Community Content?',
                text: "Are you sure you want to update this community content?",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        willClose: () => {
                            document.getElementById('communityEditForm').submit();
                        },
                        background: '#101966',
                        color: '#fff',
