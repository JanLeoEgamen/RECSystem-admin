                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form id="communityEditForm" action="{{ route('communities.update', $community->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="my-3">    
                                <textarea id="content" name="content" placeholder="Enter content" class="border-gray-300 shadow-sm w-1/2 rounded-lg">{{ old('content', $community->content) }}</textarea>
                                @error('content')
                            ...
                            <div class="my-3">
                                @if($community->image)
                                    <img src="{{ asset('images/' . $community->image) }}" alt="Community Image" class="h-40 w-40 object-cover mb-2">
                                @endif
