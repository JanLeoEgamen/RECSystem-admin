            ...
            <div class="bg-gray-10 dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="sm:hidden space-y-3 mb-4">
                        <!-- Search bar -->
                        <input type="text" id="mobileSearchInput" placeholder="Search communities..." 
                    ...
                    communities.forEach((community, index) => {
                        ...
                        let row = `
                            <tr class="border-b table-row-hover dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-left column-author">${community.author}</td>
                                ...
                                <td class="px-6 py-4 text-left column-created">${community.created_at}</td>
                                <td class="px-6 py-4 text-center flex justify-center items-center space-x-2">
                                    <a href="/communities/${community.id}/edit" class="group bg-blue-100 hover:bg-blue-200 p-2 rounded-full transition">
                                    ...
                                    <button onclick="deleteCommunity(${community.id})" class="group bg-red-100 hover:bg-red-200 p-2 rounded-full transition"> 
                                        <svg xmlns="http://www.w3.org/2000/svg"
