<x-app-layout>
    <x-slot name="header">
        <x-page-header title="{{ __('Articles') }}">
                            ...
                            <table id="articlesTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-700 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-author">Article Author</th>
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-uploaded_by">Uploaded by</th>
                    ...
                    articles.forEach((article, index) => {
                        ...
                        tbody.append(`
                            <tr class="border-b table-row-hover table-row-animate dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-center column-author">${article.author}</td>
                                <td class="px-6 py-4 text-center column-uploaded_by">${article.uploaded_by}</td>
                                ...
                                <td class="px-6 py-4 text-center column-created">${article.created_at}</td>
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                error: function() {
                                    Swal.fire({
                                        title: 'Error!',
                                        text: 'Something went wrong while deleting the article.',
                                        icon: 'error',
                                        background: '#101966',
                                        color: '#fff'
                                    });
