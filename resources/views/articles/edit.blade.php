                ...
                <div class="p-8 md:p-10">
                    ...
                    <div class="mb-8 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <h3 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Edit Article</h3>
                        </div>
                        <p class="text-gray-600 dark:text-gray-400 ml-16">Update the article information below</p>
                    </div>
                    ...
                    <form id="updateArticleForm" action="{{ route('articles.update', $article->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 mb-6">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100">Article Details</h4>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input value="{{ old('title', $article->title) }}" name="title" placeholder="Enter article title" type="text" 
                                ...
                                <div>
                                    ...
                                    <input value="{{ old('author', $article->author) }}" name="author" placeholder="Enter article author" type="text" 
                                ...
                                <div>
                                    ...
                                    <textarea name="content" placeholder="Enter article content" rows="5"
                                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-violet-500 focus:ring-2 focus:ring-violet-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4">{{ old('content', $article->content) }}</textarea>
                                    @error('content')
                                    <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300 mb-6">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100">Article Image</h4>
                            </div>
                            ...
                            <div>
                                <label for="image" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    <span class="flex items-center gap-2">
                                        ...
                                        {{ $article->image ? 'Replace Image' : 'Upload Image' }}
                                    </span>
                                </label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative inline-block">
                                        <img src="{{ asset('images/' . $article->image) }}" alt="Current Article Image" class="max-w-full h-auto rounded-lg shadow-lg border-2 border-gray-300 dark:border-gray-600" style="max-height: 400px;">
                                ...
                                @enderror
                                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">{{ $article->image ? 'Leave empty to keep current image' : 'Please upload an image for the article' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="checkbox" name="status" id="status" class="w-5 h-5 rounded text-cyan-600 focus:ring-2 focus:ring-cyan-500 dark:bg-gray-700 dark:border-gray-600 transition-all duration-200" value="1" 
                                ...
                                <button type="button" id="updateArticleBtn" 
