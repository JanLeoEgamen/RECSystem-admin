                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('quizzes.update', $quiz->id) }}" method="post" id="quizForm">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $quiz->title) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="time_limit" id="time_limit" value="{{ old('time_limit', $quiz->time_limit) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <x-slot name="script">
        <script>
            ...
            function addQuestion(questionData = null) {
                ...
                const questionType = questionData ? questionData.type : 'multiple_choice';
                ...
                questionDiv.innerHTML = `
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="questions[${questionId}][question]" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>${questionText}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="questions[${questionId}][points]" min="1" value="${questionPoints}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    </div>
                ...
                if (questionData) {
                    ...
                    switch(questionData.type) {
                                    ...
                                    <div class="multiple-choice-answers space-y-2 mt-2">
                                        ${questionData.answers.map((answer, index) => `
                                            <div class="multiple-choice-answer flex items-center space-x-2">
                                                <input type="text" name="questions[${questionId}][answers][${index}][answer]" value="${answer.answer}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                                <input type="radio" name="questions[${questionId}][correct_answer]" value="${index}" ${answer.is_correct ? 'checked' : ''} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" required>
                        ...
                        case 'identification':
                            questionDiv.querySelector('.answers-container').innerHTML = `
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Correct Answer</label>
                                    <input type="text" name="questions[${questionId}][correct_answer]" value="${questionData.answers[0].answer}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                </div>
                            `;
                            break;
                                    ...
                                    <div class="enumeration-items space-y-2 mt-2">
                                        ${questionData.answers.map((answer, index) => `
                                            <div class="enumeration-item flex items-center space-x-2">
                                                <input type="text" name="questions[${questionId}][enumeration_items][${index}]" value="${answer.answer}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    ...
                    addQuestion({
                        ...
                        answers: [
                            @foreach($question->answers as $answer)
                                {
                                    answer: '{{ addslashes($answer->answer) }}',
