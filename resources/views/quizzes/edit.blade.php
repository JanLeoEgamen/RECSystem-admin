                    ...
                    <form action="{{ route('quizzes.update', $quiz->id) }}" method="post" id="updateForm">
                        ...
                        <div>
                            ...
                            <div class="mt-8">
                                ...
                                <button type="button" id="add-question" class="mt-4 flex items-center 
                                    dark:bg-gray-900 dark:text-white dark:border-gray-100 
                                    dark:hover:bg-gray-700 dark:hover:text-white dark:hover:border-gray-100px-4 py-2 text-sm text-green-600 hover:text-white 
                                    hover:bg-green-600 rounded-md transition-colors duration-200 border border-green-100 hover:border-green-600 font-medium">
