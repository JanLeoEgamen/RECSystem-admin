                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('faqs.update', $faq->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">    
                                <input value="{{ old('question', $faq->question) }}" name="question" placeholder="Enter question" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                @error('question')
                            ...
                            <div class="my-3">    
                                <textarea name="answer" placeholder="Enter answer" class="border-gray-300 shadow-sm w-1/2 rounded-lg">{{ old('answer', $faq->answer) }}</textarea>
                                @error('answer')
                                <p class="text-red-400 font-medium"> {{ $message }} </p>
                                @enderror
                            </div>
