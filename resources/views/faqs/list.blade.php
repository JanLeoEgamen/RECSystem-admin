<x-app-layout>
    <x-slot name="header">
        <x-page-header title="{{ __('Frequently Asked Questions (FAQs)') }}">
            <x-slot name="createButton">
                <x-create-button 
                    :route="route('faqs.create')" 
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative w-48">
                                ...
                                <input type="text" id="searchInput" 
                                    placeholder="Search Question" class="pl-8 pr-2 py-2 border border-gray-300 dark:border-gray-600 
                    ...
                    <div class="sm:hidden space-y-3 mb-4">
                        <div class="relative w-full">
                            ...
                            <input type="text" id="mobileSearchInput" placeholder="Search Question" 
                            ...
                            <table id="faqsTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-700 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-question">Question</th>
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-answer">Answer</th>
                    ...
                    faqs.forEach((faq, index) => {
                        ...
                        let row = `
                            <tr class="border-b table-row-hover table-row-animate dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-center column-author">${faq.author}</td>
                                ...
                                <td class="px-6 py-4 text-center column-created">${faq.created_at}</td>
