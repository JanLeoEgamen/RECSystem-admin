                    ...
                    <form id="createForm" action="{{ route('sections.store') }}" method="post">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">Section Details</h3>
                            </div>
                                ...
                                <div>
                                    <label for="bureau_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                        <span class="flex items-center gap-2">
                                            ...
                                            Parent Bureau <span class="text-red-500">*</span>
                                        </span>
                                    </label>
                                    <select 
                                        name="bureau_id" 
                            ...
                            <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                                <div class="flex gap-3">
                                    ...
                                    <div class="text-sm text-blue-800 dark:text-blue-300">
                                        <p class="font-semibold mb-1">Section Organization:</p>
