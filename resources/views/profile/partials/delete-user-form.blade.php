        ...
        <div class="relative overflow-hidden bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/20 dark:to-rose-900/20 border-l-4 border-red-500 dark:border-red-600 rounded-r-xl p-6">
            ...
            <div class="relative z-10">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-lg font-bold text-red-800 dark:text-red-200 mb-2">Superadmin Account Protection</h4>
                        <p class="text-red-700 dark:text-red-300 text-sm leading-relaxed mb-4">
                            As a <strong>Superadmin</strong>, your account is protected and cannot be deleted through this interface. This is a security measure to prevent accidental deletion of critical administrative accounts.
                        </p>
                        <div class="bg-red-100 dark:bg-red-900/40 rounded-lg p-4">
                            <h5 class="font-semibold text-red-800 dark:text-red-200 text-sm mb-2 flex items-center">
                            ...
                            <p class="text-red-700 dark:text-red-300 text-sm">
                                Please contact the system developers or technical support team to request account deletion. They will assist you with the proper procedures and ensure data integrity is maintained.
                            </p>
                            <div class="mt-3 flex items-center space-x-2">
                                <svg class="w-4 h-4 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span class="text-sm font-medium text-red-700 dark:text-red-300">Contact: radio@rec.org.ph.com</span>
                            </div>
                        </div>
                    </div>
                </div>
