<x-app-layout>
                    ...
                    <form id="supporterForm" action="{{ route('supporters.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">Supporter Information</h3>
                            </div>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    id="supporter_name" 
                                    name="supporter_name" 
                                    placeholder="Enter supporter or organization name" 
                                    value="{{ old('supporter_name') }}" 
                        ...
                        <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">Supporter Logo</h3>
                            </div>
                            ...
                            <div>
                                ...
                                <div id="supporterImagePreviewContainer" class="hidden mt-2 mb-4">
                                    <div class="relative inline-block">
                                        <img id="supporterImagePreview" src="" alt="Image Preview" class="max-w-full h-auto rounded-lg shadow-lg border-2 border-gray-300 dark:border-gray-600" style="max-height: 400px;">
                                        <button type="button" onclick="removeSupporterImage()" class="absolute top-2 right-2 bg-red-500 hover:bg-red-600 text-white rounded-full p-2 shadow-lg transition-colors duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                            </svg>
                                        </button>
                                    </div>
                                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400 font-medium" id="supporterImageFileName"></p>
                                </div>
                                
                                <!-- Upload Zone -->
                                <div id="supporterUploadZone" class="mt-2">
                                    ...
                                    <input 
                                        ...
                                        class="hidden" 
                                        required
                                        onchange="handleSupporterImageUpload(event)">
                                </div>
                        ...
                        <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                                ...
                                <input type="checkbox" name="status" id="status" class="h-5 w-5 rounded border-gray-300 text-rose-600 focus:ring-2 focus:ring-rose-500 cursor-pointer" value="1" {{ old('status', true) ? 'checked' : '' }}>
                                <label for="status" class="ml-3 cursor-pointer">
                                    <span class="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                        ...
                                        Active - Show this supporter on the website
                                    </span>
                                    <span class="text-xs text-gray-500 dark:text-gray-400 ml-7">Uncheck to hide this supporter from public view</span>
                                </label>
                            </div>
                        </div>
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-blue-700 dark:text-blue-400">
                                                This page allows you to add new supporters with their logos to showcase partnerships and sponsors on the website.
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function handleSupporterImageUpload(event) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    document.getElementById('supporterImagePreview').src = e.target.result;
                    document.getElementById('supporterImagePreviewContainer').classList.remove('hidden');
                    document.getElementById('supporterUploadZone').classList.add('hidden');
                    document.getElementById('supporterImageFileName').textContent = file.name;
                }
        ...
        function removeSupporterImage() {
            document.getElementById('image').value = '';
            document.getElementById('supporterImagePreview').src = '';
            document.getElementById('supporterImagePreviewContainer').classList.add('hidden');
            document.getElementById('supporterUploadZone').classList.remove('hidden');
            document.getElementById('supporterImageFileName').textContent = '';
        }
    </script>
</x-app-layout>