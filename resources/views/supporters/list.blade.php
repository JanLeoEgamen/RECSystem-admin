<x-app-layout>
    <x-slot name="header">
        <x-page-header title="{{ __('Supporters') }}">
            <x-slot name="createButton">
                <x-create-button 
                    :route="route('supporters.create')" 
                    permission="create supporters" />
            </x-slot>
        </x-page-header>
    </x-slot>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                ...
                                <div class="flex flex-col space-y-2">
                                    ...
                                    <select id="sortBy" class="form-select bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 dark:text-gray-300 rounded-lg px-4 py-2.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 hover:border-green-300 cursor-pointer">
                                        ...
                                        <option value="status_asc">Status (Active)</option>
                                        <option value="status_desc">Status (Inactive)</option>
                                    </select>
                                </div>
                            ...
                            <table id="supportersTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-700 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-supporter_name">Name</th>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-lg font-medium">No supporters found</p>
                                        <p class="text-sm mt-1">There are currently no supporters to display.</p>
                                    </div>
                                </td>
                            </tr>
                        `);
                    ...
                    supporters.forEach((supporter, index) => {
                        ...
                        let row = `
                            <tr class="border-b table-row-hover table-row-animate dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-center column-supporter_name">${supporter.supporter_name}</td>
                                ...
                                <td class="px-6 py-4 text-center column-author">${supporter.author}</td>
                                ...
                                <td class="px-6 py-4 text-center column-created">${supporter.created_at}</td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center space-x-2">
                                    @can('edit supporters')
                                    <a href="/supporters/${supporter.id}/edit" 
