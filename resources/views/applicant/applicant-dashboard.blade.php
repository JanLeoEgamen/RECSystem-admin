        ...
        <div class="flex-1 bg-white dark:bg-gray-900 rounded-lg shadow-xl overflow-hidden transition-all duration-300 hover:shadow-lg">  
            ...
            <div id="emergency-contact" class="border-b border-gray-200 dark:border-gray-700 pb-8 transition-colors duration-300">
                ...
                <div id="license-info" style="display: none;">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label for="licenseClass" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors duration-300">License Class<span class="text-red-500 ml-1">*</span>
                        ...
                        <div>
                            <label for="licenseNumber" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors duration-300">License Number<span class="text-red-500 ml-1">*</span>
                        ...
                        <div>
                            <label for="expirationDate" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors duration-300">Expiration Date<span class="text-red-500 ml-1">*</span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div class="order-1 lg:order-1">
                    ...
                    <div class="mb-3 sm:mb-4">
                        <img src="/images/gcash.jpg" alt="GCash QR Code" class="w-full max-w-xs mx-auto sm:max-w-none sm:mx-0 h-auto rounded-lg border border-gray-200 dark:border-gray-700">
                    </div>
                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4">Please scan the QR code or send payment to:</p>
                        ...
                        <div class="flex items-start gap-2 sm:gap-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm sm:text-base text-blue-800 dark:text-blue-200 mb-1">
                                    <span class="font-semibold">GCash Number:</span> 0917 123 4567
                                </p>
                                <p class="text-sm sm:text-base text-blue-800 dark:text-blue-200 mb-1">
                                    <span class="font-semibold">Account Name:</span> Radio Engineering Circle Inc.
                                </p>
                                <p class="text-sm sm:text-base text-blue-800 dark:text-blue-200">
                                    <span class="font-semibold">Amount:</span> ₱50.00
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mt-4 sm:mt-6">
                                ...
                                <div>
                                    <label for="gcashAccountNumber" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                        GCash Account Number <span class="text-red-500">*</span>
                                    </label>
                                    ...
                                    <p id="gcashAccountNumberError" class="mt-1 text-xs sm:text-sm text-red-500 hidden">Please enter a valid 11-digit GCash number starting with 09.</p>
                                </div>
                            </div>
                        </div>
