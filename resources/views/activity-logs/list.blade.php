            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if($activities->isEmpty())
                        <p class="text-center py-4">No activity logs found.</p>
                    @else
                        <div class="space-y-4">
                                    ...
                                    <div class="mt-3 p-3 bg-gray-100 dark:bg-gray-600 rounded text-sm">
                                        <details>
                                            ...
                                            <div class="mt-2 overflow-x-auto p-2 bg-white dark:bg-gray-800 rounded">
                                                        ...
                                                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                            <thead class="bg-gray-50 dark:bg-gray-700">
                                                                <tr>
                                                                    ...
                                                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Old Value</th>
                                                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">New Value</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                                @foreach($activity->formatted_properties as $property)
                                                                    <tr>
                                                                        ...
                                                                        <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $property['old'] }}</td>
                                                                        <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $property['new'] }}</td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                        </table>
                                                ...
                                                @else
                                                    <pre class="text-sm">{{ $activity->formatted_properties['raw'] ?? '' }}</pre>
                                                @endif
                                            </div>
                                        </details>
                                    </div>
