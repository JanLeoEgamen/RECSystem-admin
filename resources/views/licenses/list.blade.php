                            ...
                            <table id="licensesTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-700 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-callsign">Callsign</th>
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-license_class">License Class</th>
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l dark:border-gray-700 border-white column-validity">License Validity</th>
                            ...
                            <tr>
                                <td colspan="9" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-lg font-medium mb-2">No licensed members found</p>
                                        <p class="text-sm">There are no licensed members matching your search criteria.</p>
                                    </div>
                                </td>
                            </tr>
                        `);
                    ...
                    licenses.forEach((license, index) => {
                        ...
                        let row = `
                            <tr class="border-b table-row-hover table-row-animate dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-center column-name">${license.name}</td>
                                <td class="px-6 py-4 text-center column-callsign">${license.callsign || 'N/A'}</td>
                                <td class="px-6 py-4 text-center column-license_class">${license.license_class}</td>
                                <td class="px-6 py-4 text-center column-membership_type">${license.membership_type || 'N/A'}</td>
                                <td class="px-6 py-4 text-center column-bureau">${license.bureau || 'N/A'}</td>
                                <td class="px-6 py-4 text-center column-section">${license.section || 'N/A'}</td>
                                <td class="px-6 py-4 text-center column-validity">${license.license_validity}</td>
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                success: function (response) {
                                    Swal.fire({
                                        title: 'Deleted!',
                                        text: 'License information has been removed successfully.',
                                        icon: 'success',
                                        background: '#101966',
                                        color: '#fff'
                                    });
                                ...
                                error: function() {
                                    Swal.fire({
                                        title: 'Error!',
                                        text: 'Something went wrong while deleting the license information.',
                                        icon: 'error',
                                        background: '#101966',
                                        color: '#fff'
                                    });
