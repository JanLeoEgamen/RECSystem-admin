                    ...
                    <form id="eventForm" action="{{ route('event-announcements.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">Event Information</h3>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea 
                                        id="caption" 
                                        name="caption" 
                                        placeholder="Enter a description or caption for the event" 
                                        rows="4"
                                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4">{{ old('caption') }}</textarea>
                                    @error('caption')
                                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        ...
                        <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">Event Image</h3>
                            </div>
                            ...
                            <div>
                                ...
                                <div id="imagePreviewContainer" class="hidden mt-2 mb-4">
                                    <div class="relative inline-block">
                                        ...
                                        <button type="button" onclick="removeEventImage()" class="absolute top-2 right-2 bg-red-500 hover:bg-red-600 text-white rounded-full p-2 shadow-lg transition-colors duration-200">
                                ...
                                <div id="uploadZone" class="mt-2">
                                    ...
                                    <input 
                                        ...
                                        class="hidden" 
                                        required
                                        onchange="handleEventImageUpload(event)">
                                </div>
                            ...
                            <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                                ...
                                <label for="status" class="ml-3 cursor-pointer">
                                    <span class="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                        ...
                                        Active - Show this event on the website
                                    </span>
                                    <span class="text-xs text-gray-500 dark:text-gray-400 ml-7">Uncheck to hide this event from public view</span>
                                </label>
                            </div>
                        </div>
