                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="hidden sm:flex justify-between items-center mb-4 gap-4">
                                        ...
                                        <div class="p-2">
                                            <div class="space-y-2">
                                                <label class="flex items-center space-x-2 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded cursor-pointer">
                                                    <input type="checkbox" class="column-checkbox" data-column="type_name" checked>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <input type="text" id="searchInput" placeholder="Search membership types..." 
                    ...
                    <div class="sm:hidden space-y-3 mb-4">
                        <!-- Search bar -->
                        <input type="text" id="mobileSearchInput" placeholder="Search membership types..." 
                            ...
                            <table id="membershipTypesTable" class="w-full bg-white dark:bg-gray-900 text-sm">
                                <thead class="bg-[#101966] dark:bg-gray-800 text-gray-200 dark:text-gray-200">
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th class="px-6 py-3 text-center font-medium border-l border-white column-type_name">Name</th>
                    ...
                    membershipTypes.forEach((type, index) => {
                        ...
                        let row = `
                            <tr class="border-b table-row-hover dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-left column-type_name">${type.type_name}</td>
                                <td class="px-6 py-4 text-left column-created">${type.created_at}</td>
                                <td class="px-6 py-4 text-center flex justify-center items-center space-x-2">
                                    <a href="/membership-types/${type.id}/edit" class="group bg-blue-100 hover:bg-blue-200 p-2 rounded-full transition">
                                    ...
                                    <button onclick="deleteMembershipType(${type.id})" class="group bg-red-100 hover:bg-red-200 p-2 rounded-full transition"> 
                                        <svg xmlns="http://www.w3.org/2000/svg"
