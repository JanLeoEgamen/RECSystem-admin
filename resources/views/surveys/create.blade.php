                    ...
                    <form id="createForm" action="{{ route('surveys.store') }}" method="post">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">Survey Details</h3>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input value="{{ old('title') }}" name="title" id="title" placeholder="Enter survey title" type="text" 
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" placeholder="Enter survey description" 
                                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4" rows="3">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function addQuestion() {
                    ...
                    questionDiv.className = 'question-item bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6 border-2 border-gray-200 dark:border-gray-600 hover:border-cyan-400 dark:hover:border-cyan-500 transition-all duration-200';
                    ...
                    questionDiv.innerHTML = `
                        <div class="flex justify-between items-center mb-4">
                            <h4 class="font-bold text-lg text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                <span class="bg-cyan-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">${questionCount}</span>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="questions[${questionCount}][question]" placeholder="Enter your question" 
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4" required>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    <span class="flex items-center gap-2">
                                ...
                                <select name="questions[${questionCount}][type]" 
                                    class="question-type block w-full rounded-lg border-gray-300 shadow-sm focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4" required>
                            ...
                            <div class="options-container hidden">
                                ...
                                <textarea name="questions[${questionCount}][options]" 
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4" rows="3" 
                    ...
                    removeBtn.addEventListener('click', function() {
                        ...
                        questions.forEach((q, index) => {
                            ...
                            const numberBadge = q.querySelector('.bg-cyan-500');
                            if (numberBadge) numberBadge.textContent = index + 1;
                            q.querySelector('h4').innerHTML = `
                                <span class="bg-cyan-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">${index + 1}</span>
                                Question #${index + 1}
                            `;
