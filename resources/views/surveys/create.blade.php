                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('surveys.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">    
                                <textarea name="description" placeholder="Enter survey description" class="border-gray-300 shadow-sm w-full rounded-lg">{{ old('description') }}</textarea>
                                @error('description')
                                <p class="text-red-400 font-medium"> {{ $message }} </p>
                                @enderror
                            </div>
                            ...
                            <div class="my-3" id="questions-container">
                                <div class="question-row mb-6 p-4 border border-gray-200 rounded-lg">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" name="questions[0][question]" placeholder="Question text" class="border-gray-300 shadow-sm w-full rounded-lg" required>
                                    </div>
                                    <div class="mb-3">
                                        <select name="questions[0][type]" class="question-type border-gray-300 shadow-sm rounded-lg" required>
                                    ...
                                    <div class="mb-3 options-container hidden">
                                        <textarea name="questions[0][options]" placeholder="Enter options, one per line" class="border-gray-300 shadow-sm w-full rounded-lg"></textarea>
                                        <p class="text-xs text-gray-500">Enter one option per line</p>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="checkbox" name="questions[0][is_required]" id="question-0-required" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        <label for="question-0-required" class="ml-2">Required</label>
                                    </div>
                                </div>
                            </div>
