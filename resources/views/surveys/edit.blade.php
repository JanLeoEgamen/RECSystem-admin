                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form id="updateForm" action="{{ route('surveys.update', $survey->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">    
                                <input value="{{ old('title', $survey->title) }}" name="title" id="title" placeholder="Enter survey title" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                                @error('title')
                            ...
                            <div class="my-3">    
                                <textarea name="description" id="description" placeholder="Enter survey description" class="border-gray-300 shadow-sm w-full rounded-lg" rows="3">{{ old('description', $survey->description) }}</textarea>
                                @error('description')
                                <p class="text-red-400 font-medium"> {{ $message }} </p>
                                @enderror
                            </div>
                                ...
                                <div class="relative">
                                    <select name="members[]" id="members-select" multiple class="hidden">
                                        @foreach($members as $member)
                                            <option value="{{ $member->id }}" {{ $survey->members->contains($member->id) ? 'selected' : '' }}>
