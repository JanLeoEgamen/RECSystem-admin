        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200 dark:border-gray-700">
                <div class="p-4 sm:p-6 lg:p-8 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('members.update', $member->id) }}" method="post" id="applicationForm">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                                    <div>
                                        ...
                                        <input value="{{ old('first_name', $member->first_name) }}" name="first_name" type="text" 
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('middle_name', $member->middle_name) }}" name="middle_name" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                        @error('middle_name')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('last_name', $member->last_name) }}" name="last_name" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                        @error('last_name')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('suffix', $member->suffix) }}" name="suffix" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                        @error('suffix')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mt-4 sm:mt-5">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('birthdate', $member->birthdate ? \Carbon\Carbon::parse($member->birthdate)->format('Y-m-d') : '') }}" name="birthdate" type="date" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                        @error('birthdate')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('citizenship', $member->citizenship) }}" name="citizenship" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                        @error('citizenship')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="space-y-4 sm:space-y-5">
                                    <div>
                                        ...
                                        <input value="{{ old('cellphone_no', $member->cellphone_no) }}" name="cellphone_no" type="text" 
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('telephone_no', $member->telephone_no) }}" name="telephone_no" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 transition-all duration-200">
                                        @error('telephone_no')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('email_address', $member->email_address) }}" name="email_address" type="email" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500 transition-all duration-200">
                                        @error('email_address')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="space-y-4 sm:space-y-5">
                                    <div>
                                        ...
                                        <input value="{{ old('emergency_contact', $member->emergency_contact) }}" name="emergency_contact" type="text" 
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('emergency_contact_number', $member->emergency_contact_number) }}" name="emergency_contact_number" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-rose-500 focus:ring-2 focus:ring-rose-500 transition-all duration-200">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('relationship', $member->relationship) }}" name="relationship" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-rose-500 focus:ring-2 focus:ring-rose-500 transition-all duration-200">
                                        @error('relationship')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-5">
                                    <div>
                                        <label for="rec_number" class="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                            <svg class="w-4 h-4 text-slate-600 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" />
                                            </svg>
                                            Record Number
                                        </label>
                                        <input value="{{ old('rec_number', $member->rec_number) }}" name="rec_number" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-500 transition-all duration-200">
                                        @error('rec_number')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                    ...
                                    <div>
                                        <label for="membership_type_id" class="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                            <svg class="w-4 h-4 text-slate-600 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                            </svg>
                                            Membership Type
                                        </label>
                                        <select name="membership_type_id" class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-500 transition-all duration-200">
                                    ...
                                    <div>
                                        <label for="section_id" class="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                            <svg class="w-4 h-4 text-slate-600 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                            </svg>
                                            Section
                                        </label>
                                        <select name="section_id" class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-500 transition-all duration-200">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-3 grid grid-cols-2 gap-3">
                                            <label class="relative flex items-center cursor-pointer group">
                                                <input type="radio" name="status" value="Active" {{ old('status', $member->status) == 'Active' ? 'checked' : '' }} class="sr-only peer">
                                                <div class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-lg text-sm font-semibold text-gray-700 dark:text-gray-300 transition-all duration-200 peer-checked:bg-gradient-to-r peer-checked:from-green-500 peer-checked:to-emerald-600 peer-checked:border-green-500 peer-checked:text-white peer-checked:shadow-md peer-checked:shadow-green-500/50 hover:border-green-400 dark:hover:border-green-400">
                                            ...
                                            <label class="relative flex items-center cursor-pointer group">
                                                <input type="radio" name="status" value="Inactive" {{ old('status', $member->status) == 'Inactive' ? 'checked' : '' }} class="sr-only peer">
                                                <div class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-lg text-sm font-semibold text-gray-700 dark:text-gray-300 transition-all duration-200 peer-checked:bg-gradient-to-r peer-checked:from-red-500 peer-checked:to-rose-600 peer-checked:border-red-500 peer-checked:text-white peer-checked:shadow-md peer-checked:shadow-red-500/50 hover:border-red-400 dark:hover:border-red-400">
                                                    <div class="flex items-center justify-center gap-2">
                                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        @error('status')
                                        <p class="text-red-500 font-medium text-sm mt-2 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                            </svg>
                                            {{ $message }}
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mt-4 sm:mt-5">
                                    <div>
                                        <label for="membership_start" class="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                            <svg class="w-4 h-4 text-slate-600 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                            Membership Start
                                        </label>
                                        <input value="{{ old('membership_start', $member->membership_start ? \Carbon\Carbon::parse($member->membership_start)->format('Y-m-d') : '') }}" name="membership_start" type="date" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-500 transition-all duration-200">
                                    ...
                                    <div>
                                        <label for="membership_end" class="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                            <svg class="w-4 h-4 text-slate-600 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                            Membership End
                                        </label>
                                        <input value="{{ old('membership_end', $member->membership_end ? \Carbon\Carbon::parse($member->membership_end)->format('Y-m-d') : '') }}" name="membership_end" type="date" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-500 transition-all duration-200" {{ $member->is_lifetime_member ? 'disabled' : '' }}>
                                    ...
                                    <div>
                                        <label for="last_renewal_date" class="flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                            <svg class="w-4 h-4 text-slate-600 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                            Last Renewal Date
                                        </label>
                                        <input value="{{ old('last_renewal_date', $member->last_renewal_date ? \Carbon\Carbon::parse($member->last_renewal_date)->format('Y-m-d') : '') }}" name="last_renewal_date" type="date" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-slate-500 focus:ring-2 focus:ring-slate-500 transition-all duration-200">
                                    ...
                                    <div class="bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-300 dark:border-yellow-700 rounded-xl p-3">
                                        <label class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <svg class="w-4 h-4 text-yellow-500 inline" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                </svg>
                                                <span class="text-sm font-semibold">Lifetime Member</span>
                                            </div>
                                        </label>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                                    <div>
                                        ...
                                        <input value="{{ old('license_class', $member->license_class) }}" name="license_class" type="text" 
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('license_number', $member->license_number) }}" name="license_number" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-500 transition-all duration-200">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('callsign', $member->callsign) }}" name="callsign" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-500 transition-all duration-200">
                                        @error('callsign')
                                        <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('license_expiration_date', $member->license_expiration_date ? \Carbon\Carbon::parse($member->license_expiration_date)->format('Y-m-d') : '') }}" name="license_expiration_date" type="date" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-500 transition-all duration-200">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                                    <div>
                                        ...
                                        <input value="{{ old('house_building_number_name', $member->house_building_number_name) }}" name="house_building_number_name" type="text" 
                                    ...
                                    <div>
                                        ...
                                        <input value="{{ old('street_address', $member->street_address) }}" name="street_address" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-violet-500 focus:ring-2 focus:ring-violet-500 transition-all duration-200">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mt-4 sm:mt-5">
                                    <div class="sm:col-span-2">
                                        ...
                                        <input value="{{ old('zip_code', $member->zip_code) }}" name="zip_code" type="text" 
                                            class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-violet-500 focus:ring-2 focus:ring-violet-500 transition-all duration-200">
                                    @error('zip_code')
                                    <p class="text-red-500 font-medium text-sm mt-1 flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
...
$(document).ready(function() {
    $('#updateButton').on('click', function(e) {
        ...
        Swal.fire({
            ...
            text: "Are you sure you want to update this member's information?",
            icon: 'question',
