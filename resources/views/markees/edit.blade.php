                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form id="markeeForm" action="{{ route('markees.update', $markee->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <button class="inline-flex items-center px-5 py-2 text-white hover:text-[#101966] hover:border-[#101966] 
                                bg-[#101966] hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 
                                focus:ring-[#101966] border border-white font-medium dark:bg-gray-900 dark:text-white dark:border-gray-100 
                                dark:hover:bg-gray-700 dark:hover:text-white dark:hover:border-gray-100 rounded-lg text-xl leading-normal">
