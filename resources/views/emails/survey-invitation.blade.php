...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            <h1>Survey Invitation: {{ $survey->title }}</h1>

            <p>Hello {{ $member->first_name }},</p>

            <div class="survey-details">
                You have been invited to participate in the survey: <strong>{{ $survey->title }}</strong><br><br>
                ...
                @if($survey->deadline)
                    <strong>Deadline:</strong> {{ \Carbon\Carbon::parse($survey->deadline)->toFormattedDateString() }}
                @endif
            </div>

            <a href="{{ $url }}" class="button">Take Survey</a>
