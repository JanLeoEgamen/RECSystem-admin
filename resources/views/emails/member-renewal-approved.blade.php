...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            <h1>Renewal Approved</h1>
            <p>Hello {{ $memberName }},</p>

            <div class="message">
                <p>Your renewal request has been <strong>approved</strong>.</p>
                <p>Your membership is now extended until <strong>{{ \Carbon\Carbon::parse($membershipEnd)->toFormattedDateString() }}</strong>.</p>
            </div>

            <a href="{{ route('member.dashboard') }}" class="button">Go to Dashboard</a>

            <div class="custom-message">
                Thank you for continuing your membership with the Radio Engineering Circle!
            </div>
