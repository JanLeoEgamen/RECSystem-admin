                    ...
                    <form id="createEmailForm" action="{{ route('emails.store') }}" method="post">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">Email Template Details</h3>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input name="name" id="name" value="{{ old('name') }}" placeholder="Enter template name" type="text" 
                                ...
                                <div>
                                    ...
                                    <input name="subject" id="subject" value="{{ old('subject') }}" placeholder="Enter email subject" type="text" 
                                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-sky-500 focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4">
                                    @error('subject')
                                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div>
                                    ...
                                    <div class="mb-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                        <p class="text-xs text-blue-700 dark:text-blue-300 flex items-start gap-2">
                                            ...
                                            <span>Compose your email message. You can use HTML formatting if needed.</span>
                                        </p>
                                    </div>
                                    <textarea name="body" id="body" placeholder="Enter email body" rows="8"
                                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-sky-500 focus:ring-2 focus:ring-sky-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all duration-200 py-3 px-4">{{ old('body') }}</textarea>
                                    @error('body')
                                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
