           ...
           <!-- Reset Password Section -->
            ...
            <div class="glass-card rounded-2xl p-8 slide-in">
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6" id="reset-password-form">
                    ...
                    <!-- Current Password -->
                    <div class="slide-in">
                        <label for="current_password" class="block text-white font-medium mb-3 text-sm flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path>
                            </svg>
                            Current Password <span class="text-red-400 ml-1">*</span>
                        </label>
                        <div class="relative">
                            <input 
                                id="current_password" 
                            ...
                            <button type="button" 
                                ...
                                <!-- Open eye -->
                                <svg id="current-password-eye-icon" class="w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <!-- Closed eye -->
                                <svg id="current-password-eye-slash-icon" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
