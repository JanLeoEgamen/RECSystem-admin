...
<head>
    ...
    <title>{{ config('app.name', 'RECInc') }} - Login</title>
...
<body class="bg-gradient-blue  .dark .bg-gradient-blue min-h-screen">
    ...
    <main class="flex-1 flex items-center justify-center px-6 py-8 dark">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8 slide-in">
                <h2 class="text-3xl sm:text-4xl font-bold text-white mb-3 dark:text-white">Welcome Back</h2>
                <p class="text-white/80 text-lg dark:text-gray-300">Sign in to access your member portal</p>
            </div>
            ...
            <div class="glass-card rounded-2xl p-8 slide-in dark:bg-gray-800/80 dark:backdrop-blur-md dark:border dark:border-gray-700/50">
                <x-auth-session-status class="mb-6 p-4 bg-green-500/20 backdrop-blur-sm border border-green-400/30 rounded-xl text-white font-medium dark:bg-green-600/20 dark:border-green-500/30" :status="session('status')" />
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="slide-in">
                        ...
                        />
                        <x-input-error :messages="$errors->get('email')" class="mt-2 text-sm text-red-300 dark:text-red-400" />
                    </div>

                    <!-- Password Field -->
                    <div class="slide-in">
                        <label for="password" class="block text-white font-medium mb-3 text-sm dark:text-gray-200">Password</label>
                        <div class="relative">
                            <x-text-input 
                                id="password" 
                                dusk="password-input"
                                class="modern-input w-full text-white placeholder-white/60 pr-12 dark:bg-gray-700/50 dark:border-gray-600 dark:placeholder-gray-400/60 dark:text-white"
                                type="password"
                                name="password"
                                required 
                            ...
                            <button type="button" 
                                    ...
                                    class="absolute right-4 top-1/2 transform -translate-y-1/2 text-white/60 hover:text-white transition-colors dark:text-gray-400 dark:hover:text-white"
                        ...
                        <x-input-error :messages="$errors->get('password')" class="mt-2 text-sm text-red-300 dark:text-red-400" />
                    </div>
                    ...
                    <div class="flex items-center justify-between slide-in">
                        <label for="remember_me" class="inline-flex items-center">
                            <input 
                                id="remember_me" 
                                type="checkbox" 
                                class="rounded bg-white/20 border-white/30 text-purple-600 focus:ring-purple-400 focus:ring-offset-0 dark:bg-gray-700/50 dark:border-gray-600 dark:checked:bg-purple-600" 
                                name="remember"
                            >
                            <span class="ml-3 text-sm text-white/90 dark:text-gray-300">Remember me</span>
                        </label>

                        @if (Route::has('password.request'))
                            <a class="text-sm text-white/80 hover:text-white transition-colors duration-300 dark:text-gray-400 dark:hover:text-white" 
