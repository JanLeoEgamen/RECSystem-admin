    ...
    <main class="flex-1 flex items-center justify-center py-8 px-4 sm:px-8">
        <div class="w-full max-w-md bg-white/30 backdrop-blur-lg rounded-xl border-2 border-white shadow-xl overflow-hidden p-8">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-white">Welcome Back, Admin</h2>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <label for="remember_me" class="inline-flex items-center">
                        <input 
                            id="remember_me" 
                            type="checkbox" 
                            class="rounded bg-white/20 border-white/30 text-indigo-600 focus:ring-white" 
                            name="remember"
                        >
                    ...
                    @if (Route::has('password.request'))
                        <a class="text-sm text-white hover:text-white/80 transition-colors" href="{{ route('password.request') }}">
                            {{ __('Forgot password?') }}
                        </a>
                    @endif
                </div>
                ...
                <div class="flex justify-between items-center">
                    <a href="{{ url('/') }}" class="flex items-center text-white hover:text-white/80 transition-colors">
            ...
            @if (Route::has('register'))
                <div class="mt-8 text-center text-sm text-white">
                    ...
                    <a href="{{ route('register') }}" class="font-medium text-white hover:text-white/80 transition-colors">
                        {{ __('Create one') }}
                    </a>
                </div>
            @endif
