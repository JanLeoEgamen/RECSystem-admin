...
<!-- Right Sidebar -->
<aside x-show="rightSidebarOpen || $screen('xl')"
       @click.away="if ($screen('sm')) rightSidebarOpen = false"
       class="fixed inset-y-0 right-0 z-50 w-72 flex flex-col bg-[#101966] right-sidebar-shadow transition-all duration-300 ease-in-out transform"
       :class="{
           'translate-x-full xl:translate-x-0': !rightSidebarOpen,
