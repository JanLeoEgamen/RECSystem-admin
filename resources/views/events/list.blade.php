                                ...
                                <td colspan="10" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center space-y-4">
                                        <svg class="w-16 h-16 text-gray-300 dark:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 4v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4m14 0v4a2 2 0 01-2 2h-2a2 2 0 01-2-2v-4M4 7h16"/>
                                        </svg>
                                        <div class="text-lg font-medium">No events found</div>
                                        <div class="text-sm">There are currently no events to display.</div>
                                    </div>
                                </td>
                            </tr>
                        `);
