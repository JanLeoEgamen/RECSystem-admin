        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table id="reviewersTable" class="w-full">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#reviewersTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('reviewers.index') }}",
                    columns: [
                        { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                        { data: 'title', name: 'title' },
                        { data: 'questions_count', name: 'questions_count', searchable: false },
            ...
            function deleteReviewer(id) {
                if (confirm("Are you sure you want to delete this reviewer and all its responses?")) {
                    $.ajax({
                        url: '{{ route("reviewers.destroy") }}',
                        type: 'delete',
                        data: {id: id},
                        dataType: 'json',
                        headers: {
                        ...
                        success: function(response) {
                            $('#reviewersTable').DataTable().ajax.reload();
                        }
                    });
                }
            }
